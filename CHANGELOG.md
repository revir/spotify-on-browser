...
- Larger, more immersive player interface.
- Seekbar with progress display and click-to-seek.
- Smart playback mode button: cycle through shuffle, repeat one, and normal modes.
- Queue panel to view and manage upcoming tracks.
- Library panel to browse your likes, saved albums, playlists, and podcasts.
- Full podcast and episode support.

**Improvements**

- Visual indicators when shuffle or repeat toggle is unavailable.
- Previous/next buttons disabled when no track is available.
- Fixed like button clickable area.
- Fixed tooltips not showing on disabled buttons.
- Redesigned options page with keyboard shortcut setup guide.
